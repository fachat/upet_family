...
clone:
	...
	for i in roms fpga ultracpu micropet ultipet ultrabus wifi-option; do (cd $$i; make clone;) done

update:
	git pull
	for i in roms fpga ultracpu micropet ultipet ultrabus wifi-option; do (cd $$i; make update;) done
